<template>
    <div>
        <FloatLabel class="w-full" :variant="variant">
            <InputNumber size="small" v-model="model" mode="currency" :currency="currency" :autofocus="autofocus" class="w-full" :invalid="isInvalid" :min="0" :maxFractionDigits="8" :minFractionDigits="2" />
