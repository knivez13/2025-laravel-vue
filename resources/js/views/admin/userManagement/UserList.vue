...
import { useUserListStore } from '@/stores/admin/userManagement/useUserListStore.js';
const { fnFetch, fnStore, fnUpdate, fnDelete, set_keywords, set_processing, set_rows, set_page, set_sort, tigger_modal } = useUserListStore();
const { error, processing, token, option } = storeToRefs(useUserListStore());
