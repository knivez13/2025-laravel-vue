...
const useStore = useDynamicStore('admin-maintenance-video-type', 'admin/maintenance/videoType');
...
export default function useVideoType() {
    const crud = useCrudComposable('sample', useStore, columnDefinition, formDefinition, 'Video Type');
