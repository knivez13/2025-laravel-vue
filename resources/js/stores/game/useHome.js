...
const api = new Resource('game/dashboard');

export const useHome = defineStore('game-home', {
    state: () => ({
        ///data
        list: [],
        live_games: [],
        ...
        async fnFetch() {
            ...
            await api
                ...
                .then(({ data }) => {
                    ...
                    this.live_games = api.decrypt(data?.data)?.live_games;
                    this.virtual_games = api.decrypt(data?.data)?.virtual_games;
                })
                .catch((e) => {
                    this.error = e;
