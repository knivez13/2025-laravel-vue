...
const api = new Resource('agent/transaction-menu/withdraw-comission');

export const useWithdrawCommission = defineStore('agent-transaction-menu-withdraw-comission', {
    state: () => ({
        ///data
        list: [],
