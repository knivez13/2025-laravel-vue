...
const api = new Resource('admin/transfer-balance');

export const useTransferBalance = defineStore('admin-transfer-balance', {
    state: () => ({
        ///data
        list: [],
        user_list: [],
        ...
        async fnFetch() {
            ...
            await api
                ...
                .then(({ data }) => {
                    ...
                    this.user_list = api.decrypt(data?.data)?.user_list;
