...
const api = new Resource('admin/game-moderator/live-videos');

export const useLiveVideo = defineStore('admin-game-moderator-videos', {
    state: () => ({
        ///data
        video_type: [],
        video_list: [],
        ...
        async fnFetch() {
            ...
            await api
                ...
                .then(({ data }) => {
                    ...
                    this.video_type = api.decrypt(data?.data)?.video_type;
