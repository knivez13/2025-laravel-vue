...
const api = new Resource('admin/super-admin/bank-account');

export const useBankAccount = defineStore('admin-super-admin-bank-account', {
    state: () => ({
        ///data
        list: [],
        bank_account_type: [],
        ...
        async fnFetch() {
            ...
            await api
                ...
                .then(({ data }) => {
                    ...
                    this.bank_account_type = api.decrypt(data?.data)?.bank_account_type;
