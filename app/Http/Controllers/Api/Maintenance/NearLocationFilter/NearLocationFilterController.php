...
use App\Http\Controllers\Api\Maintenance\NearLocationFilter\NearLocationFilterInterface;

class NearLocationFilterController extends Controller
{
    protected $interface;

    public function __construct(NearLocationFilterInterface $interface)
    {
