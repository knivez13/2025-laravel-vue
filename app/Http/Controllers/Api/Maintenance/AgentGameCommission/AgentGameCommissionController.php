...
use App\Http\Controllers\Api\Maintenance\AgentGameCommission\AgentGameCommissionInterface;

class AgentGameCommissionController extends Controller
{
    protected $interface;

    public function __construct(AgentGameCommissionInterface $interface)
    {
