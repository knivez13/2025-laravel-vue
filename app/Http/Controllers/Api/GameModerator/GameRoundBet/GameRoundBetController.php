...
use App\Http\Controllers\Api\GameModerator\GameRoundBet\GameRoundBetInterface;

class GameRoundBetController extends Controller
{
    protected $interface;

    public function __construct(GameRoundBetInterface $interface)
    {
