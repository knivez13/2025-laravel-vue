...
use App\Http\Controllers\Api\GameModerator\GameListRound\GameListRoundInterface;

class GameListRoundController extends Controller
{
    protected $interface;

    public function __construct(GameListRoundInterface $interface)
    {
