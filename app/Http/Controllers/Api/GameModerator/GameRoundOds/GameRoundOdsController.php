...
use App\Http\Controllers\Api\GameModerator\GameRoundOds\GameRoundOdsInterface;

class GameRoundOdsController extends Controller
{
    protected $interface;

    public function __construct(GameRoundOdsInterface $interface)
    {
